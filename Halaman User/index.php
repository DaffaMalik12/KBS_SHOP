...
<body>
    <div class="container max-w-screen-xl transition-all md:transition-all lg:transition-all overflow-x-hidden">
        ...
        <nav class="bg-[#DEDEDE]" data-aos="fade-down">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" class="flex items-center">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-black">KBS_SHOP</span>
                </a>
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border-black rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0">
                        <li>
                            ...
                            <li>
                                <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Artikel</a>
                            </li>
                            <li>
                                <a href="../login.php" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Admin</a>
                            </li>
                            ...
                            <div id="dropdownNavbar" class="z-10 hidden font-normal bg-black divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                    ...
                                    <li>
                                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tiktok</a>
                                    </li>
                                    <li>
        ...
        <!-- Jumbotron -->
        <section class="bg-[#7CE5DE] lg:max-w-full lg:h-full" data-aos="fade-left">
            <div class="py-8 px-4 mx-auto  text-left lg:py-16 lg:h-full lg:flex-row flex flex-col-reverse">
                <div>
                    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-red-600 lg:pl-5">KBS_SHOP</h1>
                    <p class="mb-8 text-lg font-normal text-black lg:text-xl sm:px-0 lg:px-0 lg:pl-5 "> Apa yang bikin kita beda? Selain produk berkualitas tinggi, kita juga punya stok barang yang selalu ready. Jadi, kamu bisa belanja dengan tenang tanpa harus khawatir kehabisan. Plus, harganya juga bersahabat banget sama dompet kamu. Gak ada lagi alasan buat gak upgrade peralatan teknologimu!</p>
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-start sm:space-y-0 sm:space-x-4 lg:pl-5 lg:-mt-4 hover:scale-x-75 transition hover:duration-400">
                ...
                <img src="../img/Gambar.png" class="mx-auto  lg:-mt-6 drop-shadow-2xl lg:h-full">
            </div>
        </section>
        <!-- Akhir Jumbotron -->

        <!-- Jumbotron Stok Barang -->
        <section class="container max-w-full max-h-full bg-[url('../img/26669.jpg')]" data-aos="fade-down-right">
            <h2 class="text-center font-bold text-2xl py-5 font-sans lg:text-center">STOK BARANG KAMI</h2>
            <div class="px-6 font-inter sm:flex sm:flex-wrap sm:gap-6 sm:justify-evenly">
                <div class="rounded-md shadow-lg overflow-hidden mb-10 sm:w-64 md:w-80 sm:mb-0 lg:72 bg-white">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class="text-sm text-slate-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, minus!</p>
                    </div>
                </div>
                ...
                <div class="rounded-md shadow-lg overflow-hidden mb-10 sm:w-64 md:w-80 sm:mb-0 lg:72 bg-white lg:mb-10">
                    <img src="https://source.unsplash.com/600x400" alt="" class="w-full">
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2 text-slate-700">Image Title</div>
                        <p class="text-sm text-slate-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, minus!</p>
        ...
        <section class="bg-[#757070]" data-aos="fade-left">
            <h2 class="text-white font-bold font-sans px-5 py-5 text-2xl">Review Customer</h2>
            <hr class="w-30  mx-5">
        ...
        <!-- Footer -->
        <footer class="bg-white dark:bg-gray-900" data-aos="fade-up-right">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" class="flex items-center">
                            <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" />
                            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">KBS_SHOP</span>
                        </a>
                    </div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <a href="https://web.facebook.com/daffa.malik.5055/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
